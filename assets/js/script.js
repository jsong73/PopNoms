...
function getData(event){
    ...
    //makes sure user input is displayed with no case sensitivity
    ...
    .then(function(data){
        ...
        //matching resteraunt reviews with resteraunt alias (since reviews come out of order)
        ...
        .then(function(data){
            ...
            for(let i=0; i < data.reviews.length; i++){
                ...
                //parses through yelp api alias and matches with the reviews(since reviews come out of order)
